	...
	$prefix, array(
		...
		'fields' => array(
			...
			array(
				...
				'subtitle' => __( 'Select which theme style you want to display. Browse themes <a href="https://demo.shapedplugin.com/woocommerce-product-slider/" target="_blank">demo</a> in action!', 'woo-product-slider' ),
				'options'  => array(
					'theme_one'   => array(
	...
	$prefix, array(
		...
		'fields' => array(
			array(
				'type'    => 'notice',
				'style'   => 'warning',
				'content' => __( 'The Following Typography (900+ Google Fonts) options are available in the <a href="https://shapedplugin.com/plugin/woocommerce-product-slider-pro/?ref=1">Pro Version</a> only except the <b>Slider Section Title, Product Name, Product Price</b> Font size and color fields.', 'woo-product-slider' ),
			),
			array(
