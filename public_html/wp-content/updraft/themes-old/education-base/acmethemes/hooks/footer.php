                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 init-animate fadeInDown">
                            ...
                            if( isset( $education_base_customizer_all_values['education-base-footer-copyright'] ) ): ?>
                                <p class="text-center">
                                  <?php echo '<img src="https://e-xpande.com/wp-content/uploads/2020/08/pie.png" width="75" height="75"><br>'.wp_kses_post( $education_base_customizer_all_values['education-base-footer-copyright'] ); ?>
                                </p>
                            <?php endif;
                            ?>
                        </div>
                        <div class="col-sm-4 init-animate fadeInDown">
                            <div class="footer-copyright border text-right">
                                <div class="site-info">
                                    <?php printf( esc_html__( '%1$s by %2$s', 'education-base' ), 'Implementado', '<a href="http://www.redsitsolutions.com/" rel="designer">REDITS SOLUTIONS</a>' ); ?>
                                </div><!-- .site-info -->
                            </div>
                        </div>
                    </div>
