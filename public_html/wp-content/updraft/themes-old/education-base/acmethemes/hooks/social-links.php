    ...
    function education_base_social_links( ) {
        ...
        <ul class="socials init-animate">
            ...
            if ( !empty( $education_base_customizer_all_values['education-base-youtube-url'] ) ) { ?>
                <li class="youtube">
                    <a href="<?php echo esc_url( $education_base_customizer_all_values['education-base-youtube-url'] ); ?>" title="<?php esc_attr_e( 'Instagram','education-base');?>" target="_blank"><i class="fa fa-instagram"></i></a>
                </li>
            <?php }
            if ( !empty( $education_base_customizer_all_values['education-base-google-plus-url'] ) ) {
                ?>
                <li class="google-plus">
                    <a href="<?php echo esc_url( $education_base_customizer_all_values['education-base-google-plus-url'] ); ?>" title="<?php esc_attr_e( 'Linkedin','education-base');?>" target="_blank"><i class="fa fa-linkedin"></i></a>
                </li>
                <?php
            }
            ?>
